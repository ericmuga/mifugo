    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'body'=>'required',
            'dimension_id'=>'required|numeric|gt:0|exists:dimensions,id',
            'animal_id'=>'required|numeric|gt:0|exists:animals,id'
        ]);
        if($request->hasFile('avatar'))
        {
            ...
            $medium= Medium::create([
                ...
                'description'=>$request->media_description?$request->media_description:Dimension::find($request->dimension_id)->name.'_'.Animal::find($request->animal_id)->name
            ]);
